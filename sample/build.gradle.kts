...
dependencies {
    ...
    implementation("com.applovin.mediation:chartboost-adapter:9.8.1.0")
    implementation("com.applovin.mediation:facebook-adapter:6.18.0.1")
    implementation("com.applovin.mediation:fyber-adapter:8.3.1.2")
    ...
    implementation("com.applovin.mediation:vungle-adapter:7.4.1.4")
    implementation("com.bigossp:bigo-ads:4.9.1")
    implementation("com.bigossp:max-mediation:4.9.1.0")

    // Not supported
    implementation("com.applovin.mediation:ironsource-adapter:8.5.0.0.0")
    implementation("com.applovin.mediation:line-adapter:2024.11.29.0")
    ...
    implementation("com.mobilefuse.sdk:mobilefuse-adapter-applovin:1.8.2.0")

    // Sub-dependencies
    implementation("com.google.android.gms:play-services-base:18.5.0") // for chartboost
    implementation("com.squareup.picasso:picasso:2.71828") // for inmobi
    implementation("androidx.recyclerview:recyclerview:1.3.2") // for inmobi
